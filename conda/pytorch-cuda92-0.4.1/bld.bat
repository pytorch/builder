...
curl https://s3.amazonaws.com/ossci-windows/magma_cuda92_release_mkl_2018.2.185.7z -k -O
7z x -aoa magma_cuda92_release_mkl_2018.2.185.7z -omagma_cuda92_release
