...
set CUDA_PATH_V9_1=C:\Program Files\NVIDIA GPU Computing Toolkit\CUDA\v9.1
...
curl https://s3.amazonaws.com/ossci-windows/magma_cuda91_release.7z -k -O
7z x -aoa magma_cuda91_release.7z -omagma_cuda91_release
set MAGMA_HOME=%cd%\magma_cuda91_release
