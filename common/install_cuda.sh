...
wget -q https://developer.nvidia.com/compute/cuda/10.1/Prod/local_installers/cuda_10.1.168_418.67_linux.    && \
chmod +x cuda_10.1.168_418.67_linux.    && \
./cuda_10.1.168_418.67_linux.    --extract=/tmp/cuda && \
rm -f cuda_10.1.168_418.67_linux.    && \
