...
FOR %%v IN (%DESIRED_PYTHON%) DO (
    ...
    if "%%v" == "3.9" call conda create -n py!PYTHON_VERSION_STR! -y -q numpy=1.19.2 "mkl=2021.4.0" pyyaml boto3 cmake ninja typing_extensions python=%%v
    if "%%v" == "3.10" call conda create -n py!PYTHON_VERSION_STR! -y -q numpy=1.21.2 "mkl=2021.4.0." pyyaml boto3 "cmake=3.19.6" ninja typing_extensions python=%%v
    if "%%v" == "3.11" call conda create -n py!PYTHON_VERSION_STR! -y -q numpy=1.22.3 "mkl=2021.4.0" pyyaml boto3 "cmake=3.19.6" ninja typing_extensions python=%%v
