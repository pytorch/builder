...
mkdir vs2017
start /wait .\vs_buildtools.exe --nocache --norestart --quiet --wait --add Microsoft.VisualStudio.Workload.VCTools --channelUri "%CD%\VisualStudio.chman"  --installChannelUri "%CD%\VisualStudio.chman"
